...
function updateFormFromResume() {
    ...
    document.getElementById("facebooklinks").value = resumeFacebook.textContent || '';
    document.getElementById("instagramlinks").value = resumeInstagram.textContent || '';
    document.getElementById("linkdinlinks").value = resumeLinkdin.textContent || '';
}
// Handle PDF download
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const facebooklinks = params.get('facebooklinks') || '';
    const instagramlinks = params.get('instagramlinks') || '';
    const linkdinlinks = params.get('linkdinlinks') || '';
    if (name || email || phone || degree || education || workExperience || skills || facebooklinks || instagramlinks || linkdinlinks) {
